...
uic.table$price = round(uic.table$price / 1000, 2)
uic.table$priceVAT = round(uic.table$price * 1.21, 2)

# set fuel specific tables
uic.diesel  <- uic.table %>% filter(., .$fuel == "Motorová nafta")
